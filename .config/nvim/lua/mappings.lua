...
vim.keymap.set('n', '<leader>h', '<<', default_opts)
vim.keymap.set('n', '<leader>l', '>>', default_opts)
...
-- focus mode
vim.keymap.set('n', '<leader>g', ':TZAtaraxis<CR>', default_opts)
...
vim.keymap.set('n', '<leader>s', ':TermCommand<CR>', default_opts)
vim.keymap.set('n', '<leader>t', ':TermFloat<CR>', default_opts)
vim.keymap.set('n', '<leader>y', ':TermSplit<CR>', default_opts)
